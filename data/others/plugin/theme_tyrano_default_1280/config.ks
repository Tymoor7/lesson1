...
;	メニューボタン非表示
	...
	/* 画像類のパス */
	tf.img_path = '../others/plugin/theme_tyrano_default_1280/image/config/';
...
;------------------------------------------------------------------------------------------------------
	...
	if(tf.text_skip == 'OFF'){
		$(".unread_off").attr("src","data/others/plugin/theme_tyrano_default_1280/image/config/c_skipoff.png");
		}else{
			$(".unread_on").attr("src","data/others/plugin/theme_tyrano_default_1280/image/config/c_skipon.png");
			}
	[endscript]
...
*skip_off
	...
	[iscript]
	$(".unread_off").attr("src","data/others/plugin/theme_tyrano_default_1280/image/config/c_skipoff.png");
	$(".unread_on").attr("src","data/others/plugin/theme_tyrano_default_1280/image/config/c_btn.gif");
	tf.text_skip = "OFF";
	[endscript]
...
*skip_on
	...
	[iscript]
	$(".unread_off").attr("src","data/others/plugin/theme_tyrano_default_1280/image/config/c_btn.gif");
	$(".unread_on").attr("src","data/others/plugin/theme_tyrano_default_1280/image/config/c_skipon.png");
	tf.text_skip = "ON";
	[endscript]
